 ...
 * @return array
 */
function rotv_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'rotv_page_menu_args' );
 ...
 * @return array
 */
function rotv_body_classes( $classes ) {
...
add_filter( 'body_class', 'rotv_body_classes' );
